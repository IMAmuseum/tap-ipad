//
//  TAPTimelineDetailViewController.h
//  TAP iPAD
//
...
@interface TAPTimelineDetailViewController : GAITrackedViewController <UICollectionViewDataSource, UICollectionViewDelegate>
